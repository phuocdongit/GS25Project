...
namespace QLBH_GS25
{
    public partial class FrmQLHoaDon : Form
    {
        ...
        private decimal LayPhanTramGiamGia(string maKhuyenMai)
        {
            ...
            string connectionString = @"Data Source= East\SQLEXPRESS;Initial Catalog= QLBH_GS25;Integrated Security=True;Persist Security Info= True;User ID=east;Password=1"; // Thay thế YourConnectionString bằng chuỗi kết nối thực tế
