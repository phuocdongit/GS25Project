...
namespace QLBH_GS25
{
    ...
    {
        public string connectString = @"Data Source= East\SQLEXPRESS;Initial Catalog= QLBH_GS25;Integrated Security=True;Persist Security Info= True;User ID=east;Password=1";
